...
public class LMOEA_CDE2 extends Algorithm{
	...
	public LMOEA_CDE2(Problem problem) {
		super(problem);
	...
	public void initialization() throws JMException, ClassNotFoundException{
		...
		variablesDetection();
		group_ = new GroupingStrategy(numOfGroup_,numVar_,numObj_).contributionGrouping(improvement_);
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		while(generations_ < maxGenerations_){
			if(generations_ <= 0.15*maxGenerations_){
				reproduction2(group_[0]);
			}else if(generations_ > 0.15*maxGenerations_  && generations_ <= 0.25*maxGenerations_){
				reproduction2(group_[1]);
			}else if(generations_ > 0.25*maxGenerations_  && generations_ <= 0.35*maxGenerations_){
				reproduction2(group_[2]);
			}else if(generations_ > 0.35*maxGenerations_  && generations_ <= 0.45*maxGenerations_){
				reproduction2(group_[3]);
			}else if(generations_ > 0.45*maxGenerations_  && generations_ <= 0.55*maxGenerations_){
				reproduction2(group_[4]);
			}else if(generations_ > 0.55*maxGenerations_  && generations_ <= 0.6*maxGenerations_){
				reproduction2(group_[5]);
			}else if(generations_ > 0.6*maxGenerations_  && generations_ <= 0.65*maxGenerations_){
				reproduction2(group_[6]);
			}else if(generations_ > 0.65*maxGenerations_  && generations_ <= 0.7*maxGenerations_){
				reproduction2(group_[7]);
			}else if(generations_ > 0.7*maxGenerations_  && generations_ <= 0.75*maxGenerations_){
				reproduction2(group_[8]);
			}else if(generations_ > 0.75*maxGenerations_  && generations_ <= 0.8*maxGenerations_){
