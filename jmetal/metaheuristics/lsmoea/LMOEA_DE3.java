...
public class LMOEA_DE3 extends Algorithm{
	...
	public LMOEA_DE3(Problem problem) {
		super(problem);
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		while(evaluations_ < maxEvaluations_){
			...
			if(T_ < numOfGroup_-1){
				if((evaluations_ - initEvaluations)%15000 == 0){
					T_++;
					int[] groupA = inGroup;
	...
	public void variablesDetection() throws ClassNotFoundException, JMException{
		...
		int k = 15; //number of segments for detection on each variable
