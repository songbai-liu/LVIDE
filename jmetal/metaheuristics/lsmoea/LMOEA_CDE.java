...
public class LMOEA_CDE extends Algorithm{
	...
	public LMOEA_CDE(Problem problem) {
		super(problem);
	...
	public void environmentalSelection1(){
		// Create the solutionSet union of solutionSet and offSpring
		unionPopulation_ = ((SolutionSet) population_).union(offspringPopulation_);
		population_.clear();
		offspringPopulation_.clear();
		...
		distance_.crowdingDistanceAssignment(unionPopulation_,problem_.getNumberOfObjectives());
