...
public class computeIGD_main_2obj {
	...
	public static void main(String[] args) throws JMException,
		...
		algorithms[9] = "LMCSO_P1";
		algorithms[10] = "LMOEA1";
		algorithms[11] = "LMOEA2";
		algorithms[12] = "LMOEA";
		for(int a=10;a<=11;a++){
			for(int i=0;i<runtimes;i++){
			   String path = "D:\\CityU\\2021\\Large-Scale Multiobjective Optimization\\Experimental Results\\" + algorithms[a];
