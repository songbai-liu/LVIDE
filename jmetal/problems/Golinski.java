...
public class Golinski extends Problem {
	...
	public static final double[] LOWERLIMIT = { 2.6, 0.7, 17.0, 7.3, 7.3, 2.9,
			5.0 };
	public static final double[] UPPERLIMIT = { 3.6, 0.8, 28.0, 8.3, 8.3, 3.9,
			5.5 };
	...
	public void evaluate(Solution solution) throws JMException {
		...
		double f1 = 0.7854 * x1 * x2 * x2
				* ((10 * x3 * x3) / 3.0 + 14.933 * x3 - 43.0934) - 1.508 * x1
				* (x6 * x6 + x7 * x7) + 7.477 * (x6 * x6 * x6 + x7 * x7 * x7)
	...
	public void evaluateConstraints(Solution solution) throws JMException {
		...
		double aux = 745.0 * x4 / (x2 * x3);
		double f2 = java.lang.Math.sqrt((aux * aux) + 1.69e7)
				/ (0.1 * x6 * x6 * x6);
		constraint[9] = -(f2 - 1300);
		double a = 745.0 * x5 / (x2 * x3);
		double b = 1.575e8;
		constraint[10] = -(java.lang.Math.sqrt(a * a + b)
				/ (0.1 * x7 * x7 * x7) - 1100.0);
