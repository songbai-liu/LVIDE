...
public class Poloni extends Problem {
	...
	public void evaluate(Solution solution) throws JMException {
		...
		final double A2 = 1.5 * Math.sin(1.0) - Math.cos(1.0) + 2
				* Math.sin(2.0) - 0.5 * Math.cos(2.0); // !< Constant A2
		...
		// The two objectives to be minimized. According to Max(f(x)) =
		// -Min(f(-x)),
		// they must be multiplied by -1. Consequently, the obtained solutions
		// must
